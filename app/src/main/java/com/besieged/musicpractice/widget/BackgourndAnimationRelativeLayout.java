...
public class BackgourndAnimationRelativeLayout extends RelativeLayout {
        ...
        objectAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M){
                    ...
                    layerDrawable.setDrawableByLayerId(R.drawable.ic_blackground,layerDrawable.getDrawable(INDEX_FOREGROUND));
                }
    ...
    public void setForeground(Drawable drawable) {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M){
            ...
            layerDrawable.setDrawableByLayerId(R.drawable.ic_blackground,drawable);
        }
    }

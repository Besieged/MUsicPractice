...
public class LrcRow implements Comparable<LrcRow> {
    ...
    public static final List<LrcRow> createRows(String lrcLine) {
        // [01:15.33] 或者 [00:00] 或者 [01:12.220]这种格式
        Boolean Form1 = lrcLine.startsWith("[") && lrcLine.indexOf("]") == 9;
        Boolean Form2 = lrcLine.startsWith("[") && lrcLine.indexOf("]") == 6;
        Boolean Form3 = lrcLine.startsWith("[") && lrcLine.indexOf("]") == 10;
